...
namespace signalr
{
    ...
    public:
        ...
        SIGNALRCLIENT_API hub_connection_builder& with_http_client(std::function<std::shared_ptr<http_client>()> factory);
    ...
    private:
        ...
        std::function<std::shared_ptr<http_client>()> m_http_factory;
    };
}
